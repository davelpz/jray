...
public class RingPattern extends TwoColorPatternBase {

    @Inject
    public RingPattern(@Named("identityMatrix") Matrix identityMatrix, @Assisted("a") Color a, @Assisted("b")  Color b) {
